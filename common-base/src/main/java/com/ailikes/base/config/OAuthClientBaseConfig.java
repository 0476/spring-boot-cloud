...
//import com.ailikes.base.filter.OAuth2ClientAuthenticationProcessingFilter;
...
// */
//@Configuration
//public class OAuthClientBaseConfig {
//
//
//    private String redirectUri = "/callback";
//
//    private String checkTokenUrl = "http://localhost:5000/uc/oauth/token";
//    @Bean
...
//     */
//    @Bean
//    public OAuth2ClientAuthenticationProcessingFilter oauth2ClientAuthenticationProcessingFilter(OAuth2RestTemplate oauth2RestTemplate,RemoteTokenServices tokenService) {
